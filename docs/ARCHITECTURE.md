...
See [the direct NR contract](direct-nr-relay.md).
...
rejected placeholder. See [platform installation](distribution.md).
...
discarded. [Lifecycle and monitoring](preview-performance.md) describe limits.
...
`sidecar/protocol/frame-stream-v1.md` are separate diagnostics.
