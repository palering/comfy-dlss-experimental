...
English · [简体中文](dlss5-runtime-research-2026-09.zh-CN.md)
...
[architecture](ARCHITECTURE.en.md) and [external-file preparation](DLL_PREPARATION.en.md).
...
details remain in the [direct relay guide](direct-nr-relay.en.md) and
[C++ quality guide](sidecar-cpp-quality.en.md).
