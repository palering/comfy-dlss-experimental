...
English · [简体中文](frame-stream-v1.zh-CN.md)

Audience: public

This is the retained GPU-copy diagnostic protocol, **not active NR's D5V2**.
It carries normalized frames between the ComfyUI Python process and
